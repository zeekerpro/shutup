                        ...
                        Button(
                            onClick = {
                                ...
                                if(audioManager.ringerMode == AudioManager.RINGER_MODE_VIBRATE){
                                    ...
                                    audioManager.setStreamVolume(AudioManager.STREAM_MUSIC, preMusicVolume, FLAG_SHOW_UI)
                                    audioManager.setStreamVolume(AudioManager.STREAM_NOTIFICATION, preNotificationVolume, FLAG_SHOW_UI)
                                    btnLabel = "mute"
                                }else{
                                    ...
                                    audioManager.setStreamVolume(AudioManager.STREAM_NOTIFICATION, 0, FLAG_SHOW_UI)
                                    btnLabel = "restore"
                                }
                            },
